...
abstract public class CountDownSchedulerRunable
{
    ...
    CountDownSchedulerRunable(long duration,long period,TimeUnit timeUnit)
    {
    ...
    CountDownSchedulerRunable(long duration,long period)
    {
